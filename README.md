...
Multi-source data aggregation and report generation tool. Pull data from databases, REST APIs, and files to create beautiful, automated reports in PDF, Excel, HTML, and JSON formats.
